  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden gradient-hero">
        <div className="absolute inset-0 bg-blue-900/20 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900/40 via-transparent to-transparent"></div>
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-blue-100/90 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-up" style={{ animationDelay: "0.2s" }}>
      ...
      <section id="capabilities" className="py-20 lg:py-28 bg-slate-50">
        <div className="container">
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 text-primary font-medium rounded-full text-sm mb-6">
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative bg-slate-100 rounded-3xl p-8 sm:p-12 border border-border shadow-elevated">
                <div className="aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden shadow-lg relative bg-white flex items-center justify-center border border-slate-200 group">
